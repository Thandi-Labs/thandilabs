...
const Register = () => {
  ...
  const meta = STRENGTH_META[strength - 1];
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-start gap-2.5">
                <input
                  ...
                  className="mt-0.5 h-4 w-4 rounded border-zinc-300 accent-emerald-500 dark:border-white/20"
                />
